...
public class WebBaseTest {
    ...
    private static final String DEFAULT_IE_DRIVER_PATH = "src/main/resources/drivers/IEDriverServer.exe";
    private static final String DEFAULT_CHROME_DRIVER_PATH = "src/main/resources/drivers/chromedriver.exe";
    private static final String DEFAULT_GECKO_DRIVER_PATH="src/main/resources/drivers/geckodriver.exe";
